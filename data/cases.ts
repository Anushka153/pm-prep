export const cases = [
  {
    id: 1, company: "Amazon", score: 7.5,
    type: ["execution","amazon"],
    title: "Drop in Repeat Purchases",
    question: "Amazon is seeing a drop in repeat purchases from customers who bought a product for the first time. How would you diagnose the problem and what would you do about it?",
    nailed: [
    ...
    keywords: ["Cohort analysis","Churn rate","LTV","CAC","Retention curve","NPS baseline"],
    model: [
  ...
  {
    id: 2, company: "Amazon", score: 8.0,
    type: ["execution","amazon"],
    title: "Add-to-Cart Drop 15%",
    question: "You are the PM for Amazon's mobile app. The CEO tells you the add-to-cart rate has dropped by 15% over the last two weeks. What do you do?",
    nailed: [
    ...
    keywords: ["Funnel analysis","Conversion rate","Session replay","Error rate","Deployment rollback"],
    model: []
  },
  {
    id: 3, company: "Amazon", score: 8.5,
    type: ["execution","amazon"],
    title: "Prime — Renewal Drop 20%",
    question: "Amazon Prime membership renewals have dropped by 20% over the last quarter. How would you approach this problem?",
    nailed: [
    ...
    keywords: ["Churn rate","Subscriber LTV","Content licensing","ARPU","DAU/MAU ratio"],
    model: []
  },
  {
    id: 4, company: "YouTube", score: 9.0,
    type: ["design"],
    title: "Recommendation Algorithm Improvement",
    question: "How would you improve YouTube's recommendation algorithm?",
    nailed: [
    ...
    keywords: ["CTR","Watch time per session","Collaborative filtering","Content diversity score","Cold start","Filter bubble"],
    model: []
  },
  {
    id: 5, company: "Amazon", score: 9.0,
    type: ["design","amazon"],
    title: "Review Abuse Detection System",
    question: "Design a system to track review abuse on Amazon.com.",
    nailed: [
    ...
    keywords: ["Precision vs recall","False positive rate","Verified purchase badge","Sockpuppet accounts","Bot detection"],
    model: []
  },
  {
    id: 6, company: "Product Design", score: 9.5,
    type: ["design"],
    title: "Design an International Airport in Europe",
    question: "Design an international airport for a medium-sized European city like Prague or Valencia.",
    nailed: [
    ...
    keywords: ["Dwell time","Throughput","RPE","Common use terminal","Slot-controlled","Footfall","Yield management"],
    model: []
  },
  {
    id: 7, company: "Strategy", score: 9.0,
    type: ["strategy"],
    title: "Grofers vs Big Basket — 2010",
    question: "If you could go back to 2010, before either existed, would you build a Big Basket model or a Grofers model — and why?",
    nailed: [
    ...
    keywords: ["CAC","Dark stores","SKU density","Cold chain","Hyperlocal delivery","Unit economics","Contribution margin","GMV per order"],
    model: []
  },
  {
    id: 8, company: "Design", score: 9.0,
    type: ["design","strategy"],
    title: "Borrowing & Lending Product",
    question: "Design a product for borrowing and lending. You are building a standalone startup with Series A funding.",
    nailed: [
    ...
    keywords: ["Escrow","Two-sided marketplace","Liquidity problem","Cold start","KYC","Trust and safety"],
    model: []
  },
  {
    id: 9, company: "Lyft", score: 8.5,
    type: ["design","execution"],
    title: "Improve Ride Quality",
    question: "You are the PM for Lyft. How would you improve ride quality?",
    nailed: [
    ...
    keywords: ["Surge pricing algorithm","Geofencing","Driver utilization rate","ETA accuracy","Ride completion rate"],
    model: []
  },

  // ===== PRIORITIZATION CASES =====
  {
    id: 10, company: "Spotify for Artists", score: null, practice: true,
    type: ["prioritization"],
    title: "Prioritize Creator Tools Roadmap — RICE",
    question: "You're PM for Spotify for Artists. Five feature requests are on the table but you only have one sprint (4 weeks). Use RICE to decide what to build.",
    nailed: [
    ...
    rice: `<div style="font-size:13px;font-weight:700;color:var(--accent2);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:8px;">RICE Scoring — North Star: Artist 90-day retention</div>
<table class="rice-table">
  ...
  <tr><td>Tour date promotion</td><td>30K</td><td>2</td><td>60%</td><td>6</td><td>6,000</td></tr>
    ...
    keywords: ["RICE","North star metric","Opportunity scoring","Impact vs effort","Sprint capacity","Guardrail metric"]
  },
  {
    id: 11, company: "Notion", score: null, practice: true,
    type: ["prioritization","b2b"],
    title: "Q3 Roadmap Prioritization — 8 items, pick 3",
    question: "You're PM at Notion. 8 backlog items, 3 slots for Q3. Primary metric: team retention at 90 days. Walk me through your prioritization.",
    nailed: [
    ...
    rice: `<div style="font-size:13px;font-weight:700;color:var(--accent2);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:8px;">RICE Scoring — North Star: Team retention at 90 days</div>
<table class="rice-table">
  ...
  <tr><td>API improvements</td><td>5K devs</td><td>1</td><td>90%</td><td>6</td><td>750</td></tr>
    ...
    keywords: ["RICE","Team retention","Churn reduction","North star metric","Deprioritization rationale","B2B SaaS"]
  },

  // ===== B2B HEALTHTECH CASE =====
  {
    id: 12, company: "Digital Health (Digbi-type)", score: null, practice: true,
    type: ["b2b","design"],
    title: "Redesign the Care Coordinator Dashboard",
    question: "You're PM at a digital health company offering AI-powered health coaching (like Digbi). How would you redesign the care coordinator/coach-facing product to improve patient outcomes at scale?",
    nailed: [
    ...
    keywords: ["B2B SaaS","Clinical outcomes","Coordinator capacity","Contract renewal","Cohort analysis","At-risk queue","NPS","ARR"]
  },

  // ===== GAP DRILL CASES =====
  {
    id: 13, company: "TikTok", score: null, practice: true,
    drill: "Voice Every Assumption Aloud",
    type: ["design","drill"],
    title: "Improve TikTok Creator Monetization",
    question: "How would you improve TikTok's monetization for creators?",
    nailed: [
    ...
    keywords: ["Creator economy","Take rate","Affiliate commerce","Creator retention","GMV","Platform take rate"]
  },
  {
    id: 14, company: "DoorDash", score: null, practice: true,
    drill: "Business Metrics Unprompted",
    type: ["design","execution","drill"],
    title: "Improve DoorDash's Merchant-Facing Product",
    question: "You're PM for DoorDash's merchant product. How would you improve it?",
    nailed: [
    ...
    keywords: ["GMV","Take rate","Merchant NRR","Contribution margin","Merchant churn","Supply quality","Order completion rate"]
  },
  {
    id: 21, company: "DoorDash", score: 7.5,
    type: ["design","execution"],
    title: "Improve DoorDash Merchant Product — Live Attempt",
    question: "You're PM for DoorDash's merchant product. How would you improve it?",
    nailed: [
    ...
    keywords: ["Merchant retention rate","Order volume per merchant","GMV contribution","Merchant churn","Payout cycle","Menu management","Cancellation rate","Order accuracy","Supply-side NPS"],
    model: []
  },
  {
    id: 15, company: "Instagram", score: null, practice: true,
    drill: "Address Supply/Creator Side First",
    type: ["design","strategy","drill"],
    title: "Grow Instagram Reels",
    question: "How would you grow Instagram Reels?",
    nailed: [
    ...
    keywords: ["Creator retention","Supply-side","Cold start","Creator monetization","DAU/MAU","Algorithmic boost","Content diversity"]
  },
  {
    id: 22, company: "Instagram", score: 8.5,
    type: ["design","strategy"],
    title: "Grow Instagram Reels — Live Attempt",
    question: "How would you grow Instagram Reels?",
    nailed: [
    ...
    keywords: ["Creator retention rate","Content velocity","Watch completion rate","Skip rate","Ad inventory","CPM","Creator LTV","Cold start","Cohort benchmarking","Activation rate"],
    model: []
  },
  {
    id: 16, company: "Peer Learning Platform", score: null, practice: true,
    drill: "Name and Solve Cold Start Explicitly",
    type: ["design","strategy","drill"],
    title: "Design a Peer Skill-Sharing Platform",
    question: "Design a product for peer-to-peer professional skill sharing — practitioners teaching practitioners. You have Series A funding.",
    nailed: [
    ...
    keywords: ["Cold start","Two-sided marketplace","Supply-first","Liquidity threshold","Beachhead market","Cohort model","Take rate"]
  },
  {
    id: 17, company: "Swiggy", score: null, practice: true,
    drill: "Address the Discovery Problem",
    type: ["design","drill"],
    title: "Improve Swiggy's Food Ordering Experience",
    question: "You're PM for Swiggy's food ordering experience for consumers. How would you improve it?",
    nailed: [
    ...
    keywords: ["Discovery problem","Order conversion rate","GMV","Session-to-order rate","Dish-level search","Personalisation","Reorder rate"]
  },
  {
    id: 18, company: "Apple Maps", score: 7.5,
    type: ["strategy"],
    title: "Win Market Share for Apple Maps",
    question: "You are a PM for Apple Maps. How would you win market share? If it already has all features, how would you market it?",
    nailed: [
    ...
    keywords: ["Default distribution","Habit formation","Ecosystem lock-in","Switching cost","Activation","Commute loop","CarPlay","Privacy moat","Beachhead segment"],
    model: [
  ...
  {
    id: 19, company: "Netflix", score: 7.5,
    type: ["execution"],
    title: "NS Metric Drop",
    question: "Netflix's NS (North Star) metric has dropped. How would you diagnose the problem and what would you do about it?",
    nailed: [],
    missed: [
    ...
    keywords: ["North Star metric","Metric tree","Funnel analysis","Cohort analysis","DAU/MAU ratio","p99 / p95 latency","Streaming quality score","Play rate","Hours watched per subscriber"],
    model: [
  ...
  {
    id: 20, company: "Instagram", score: 8.5,
    type: ["design"],
    title: "Redesign Instagram DMs",
    question: "How would you redesign Instagram's DM feature?",
    nailed: [
    ...
    keywords: ["DM triage","AI classification","Signal-to-noise","Inbox tabs","Creator monetization","Collab conversion rate","Creator retention","False positive rate","Response rate"],
    model: [
  ...
  {
    id: 23, company: "Google / Gemini", score: 8.5,
    type: ["execution","google"],
    title: "Confident But Wrong — Fix Gemini's Trust Problem",
    question: "You're the PM for Gemini. Users are complaining that the product feels 'confident but wrong.' How would you fix this?",
    nailed: [
    ...
    keywords: ["Hallucination rate","Calibration","Epistemic uncertainty","Response confidence score","Thumbs-down rate","Source attribution","Query ambiguity detection","Session abandonment rate","D7 retention","Confidence signaling"],
    model: [
  ...
  {
    id: 24, company: "Product Design", score: 8,
    type: ["design","estimation"],
    title: "Design a Skyscraper Elevator + Estimate Count",
    question: "Design an elevator for a skyscraper and estimate the number of elevators needed.",
    nailed: [
    ...
    keywords: ["Utilization funnel","Peak demand","Throughput","Cycle time","Trip capacity","Destination dispatch","Express zone","Sanity check","Population density","Floor area ratio"],
    model: [
